...
import { resizeToJpeg, now, vibrate, getTodayDateString, parseDateString, toDateTimePickerFormat, fromDateTimePickerFormat, sortSymptomsByTime, determineTagColor, exportTableAsScreenshotPdf, sortEntries, sortEntriesByCategory } from "./utils";
...
export default function App() {
  ...
  // Trigger screenshot PDF once layout is stable
  useEffect(() => {
    ...
    const run = async () => {
      window.scrollTo(0, 0);
      await exportTableAsScreenshotPdf(el);
